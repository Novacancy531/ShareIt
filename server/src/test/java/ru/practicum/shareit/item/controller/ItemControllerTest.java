...
class ItemControllerTest {
    ...
    void addItem() throws Exception {
        ...
        Mockito.when(itemService.addItem(eq(1L), any(ItemDto.class))).thenReturn(itemDto);
    ...
    void updateItem() throws Exception {
        ...
        Mockito.when(itemService.updateItem(eq(1L), eq(1L), any(ItemPatchDto.class)))
    ...
    void getUserItems() throws Exception {
        ...
        Mockito.when(itemService.getUserItems(1L)).thenReturn(List.of(itemDto));
    ...
    void searchItems() throws Exception {
        ...
        Mockito.when(itemService.searchItems("Ножницы")).thenReturn(List.of(itemDto));
    ...
    void createComment() throws Exception {
        ...
        Mockito.when(itemService.createComment(eq(1L), eq(1L), any(CommentDto.class)))
